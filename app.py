...
def upload():
    ...
    target = os.path.join(APP_ROOT, 'images/origin')
    target_out = os.path.join(APP_ROOT, 'images/')
    ...
    out_image = cv2.imwrite(os.path.join(target_out,"flask"+ filename), image)
